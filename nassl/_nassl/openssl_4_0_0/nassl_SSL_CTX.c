...
// TODO : Combine/reuse the code below that's the same across all OpenSSL versions
...
// TODO: Expose SSL_CTX_set_min_proto_version() and SSL_CTX_set_max_proto_version()
