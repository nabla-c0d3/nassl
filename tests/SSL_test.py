...
class TestCommonSSL:
    ...
    def test_set_bio(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
        test_bio = nassl_module.BIO()
        test_ssl.set_bio(test_bio)

    def test_set_bio_bad(self, nassl_module: ModuleType) -> None:
        # Invalid None BIO
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
        with pytest.raises(TypeError):
            test_ssl.set_bio(None)

    def test_set_connect_state(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
    ...
    def test_get_secure_renegotiation_support(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
        test_ssl.get_secure_renegotiation_support()

    def test_get_current_compression_method(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
        test_ssl.get_current_compression_method()

    def test_get_available_compression_methods_has_zlib(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
        assert ["zlib compression"] == test_ssl.get_available_compression_methods()

    def test_set_tlsext_host_name(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
        test_ssl.set_tlsext_host_name("tests")

    def test_set_tlsext_host_name_bad(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
        with pytest.raises(TypeError):
            test_ssl.set_tlsext_host_name(None)

    def test_set_cipher_list(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
    ...
    def test_get_cipher_name(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
        test_ssl.get_cipher_name()

    def test_get_cipher_bits(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
        assert 0 == test_ssl.get_cipher_bits()

    def test_get_client_CA_list_bad(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
        assert [] == test_ssl.get_client_CA_list()

    def test_get_verify_result(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
        assert 0 == test_ssl.get_verify_result()

    def test_renegotiate(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
        test_ssl.renegotiate()

    def test_get_session(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
        test_ssl.get_session()

    def test_set_session_bad(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
        with pytest.raises(TypeError):
            test_ssl.set_session(None)

    def test_set_options_bad(self, nassl_module: ModuleType) -> None:
        test_ssl = nassl_module.SSL(nassl_module.SSL_CTX(OpenSslVersionEnum.SSLV23.value))
