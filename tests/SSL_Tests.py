...
class SSL_Tests(unittest.TestCase):
    ...
    def test_new(self):
        self.assertTrue(_nassl.SSL(_nassl.SSL_CTX(OpenSslVersionEnum.SSLV23)))
    ...
    def test_set_verify(self):
        test_ssl = _nassl.SSL(_nassl.SSL_CTX(OpenSslVersionEnum.SSLV23))
        self.assertIsNone(test_ssl.set_verify(OpenSslVerifyEnum.PEER))
