...
_SslClientTypes = Type[SslClient_OpenSSL_1_1_1] | Type[SslClient_OpenSSL_1_0_2]
...
@pytest.mark.parametrize("ssl_client_cls", [SslClient_OpenSSL_1_1_1, SslClient_OpenSSL_1_0_2])
